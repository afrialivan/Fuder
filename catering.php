...
<body id="body-pd">
  ...
  <h1 id="jud" class="text-center d-none d-xl-block fw-bold judul">Nih mitra catering kami</h1>
  <div id class="judull d-xl-none d-block text-center fw-bold">Nih mitra catering kami</div>

  <div class="row">
    <div class="col-xl-4 col-md-6 col-sm-6 col-6 kotak mb-3">
      <a href="" class="text-decoration-none">
        <div class="card">
          <img class="card-img-top img-fluid" src="img/Pratama.png" alt="Title">
