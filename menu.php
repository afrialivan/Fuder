...
<body id="body-pd">
  ...
  <h1 id="jud" class="text-center d-none d-xl-block fw-bold judul">Pilih sesuai kebutuhanmu </h1>
  <div id class="judull d-xl-none d-block text-center fw-bold">Pilih sesuai kebutuhanmu </div>

  <div class="pilihan d-none d-xl-flex">
    <div class="active-menu"></div>
    <a href="catering.php" class="menuu" onmouseover="over1()" onmouseout="out()">
      <h4>TUMPENG</h4>
      <p>4 Product</p>
    </a>
    <a href="menu.php" class="menuu" onmouseover="over2()" onmouseout="out()">
      <h4>PRASMANAN</h4>
      <p>4 Product</p>
    </a>
    <a href="chat.php" class="menuu" onmouseover="over3()" onmouseout="out()">
      <h4>SNACK/JAJANAN</h4>
      <p>4 Product</p>
    </a>
    <a href="" class="menuu" onmouseover="over4()" onmouseout="out()">
      <h4>NASI KOTAK</h4>
      <p>4 Product</p>
    </a>
    <a href="" class="menuu" onmouseover="over5()" onmouseout="out()">
      <h4>MINUMAN</h4>
      <p>4 Product</p>
    </a>
  </div>
  ...
  <div class="row">
    <div class="col-xl-6 col-md-6 col-sm-6 col-6 kotak mb-5">
      <a href="" class="text-decoration-none">
        <div class="card">
          <img class="card-img-top img-fluid" src="img/tumpeng.png" alt="Title">
          <div class="card-body text-center">
            Catering Pratama
            <p class="text-center fw-bold text-dark">Rp. 2.250.000</p>
          </div>
        </div>
      </a>
    </div>
